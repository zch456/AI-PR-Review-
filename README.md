...
当前阶段实现了项目骨架、GitHub PR URL 解析、PR 元信息获取和变更文件获取闭环：前端提交 PR 链接，后端解析出仓库 owner、仓库名和 PR 编号，并从 GitHub API 获取 PR 标题、作者、状态、分支、增删行、变更文件数量和文件级 patch。
...
- 在页面展示 owner、repo、PR 编号、标题、作者、状态、分支、增删行、变更文件数量和文件列表。
